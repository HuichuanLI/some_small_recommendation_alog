...
if __name__ == '__main__':
    ...
    for elem in ['./comment_beijiao_cut.txt', './comment_cut.txt', './comment_beiwai_cut.txt',
                 './comment_bupt_cut.txt', './comment_pku_cut.txt']:
        sourceFile = elem
        targetFile = elem.split("/")[-1].split(".txt")[0][:-4] + "_stopword.txt"
        # print(targetFile)
        # 'comment_beijiao_stopword.txt'
